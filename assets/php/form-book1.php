...
if (isset($_POST['nome']) && isset($_POST['email']) && isset($_POST['telefone']) && isset($_POST['cargo']) && isset($_POST['empresa']) && isset($_POST['area']) ){
...
$msg .= "Qual sua maior dificuldade na empresa?: " . $_POST["area"] . "<br>";
